...
class FindReplaceDialog extends Dialog {
	 ...
	 * @since 3.0
	 */
	private boolean fUseSelectedLines; // TODO: MW - remove, since this duplicates findReplacer.isGlobalSearch();
	/**
	...
	private Composite createScopeGroup(Composite parent) {
		...
		fUseSelectedLines = !findReplacer.isGlobalSearch();
	...
	public void updateTarget(IFindReplaceTarget target, boolean isTargetEditable, boolean initializeFindString) {
		...
		fUseSelectedLines = !globalSearch;
		fSelectedRangeRadioButton.setSelection(fUseSelectedLines);
